...
const ContinerButton = styled.button`
    border: none;
    cursor: pointer;
...
const hero = [
    {
        id:"1",
        ruta:"imagenes-room/desktop-image-hero-1.jpg",
    ...
    {
        id:"2",
        ruta:"imagenes-room/desktop-image-hero-2.jpg",
    ...
    {
        id:"3",
        ruta:"imagenes-room/desktop-image-hero-3.jpg",
...
function MainRoom() {
    ...
    const filtrado = hero.filter(item => item.id == valor);
    ...
    return <>
        <Container>
                ...
                <ContenHeroOne>
                    <ContainerButtons>
                        <button onClick={disminuir}>
                            <img src="imagenes-room/icon-angle-left.svg" alt="left" />
                        </button>

                        <button onClick={aumentar}>
                            <img src="imagenes-room/icon-angle-right.svg" alt="right"/>
                        </button>
                    </ContainerButtons> 
                    ...
                    <ContinerButton onClick={()=>navegacion("/projects/room-page")}>SHOP NOW
                        <span className="arrow">
                            <img src="imagenes-room/icon-arrow.svg" alt="arrow"/>
                        </span> 
                    </ContinerButton>  
                </ContenHeroOne>
            </ArticleOne>
            ...
            <ArticleTwo>
                <img src="imagenes-room/image-about-dark.jpg" alt="img-mobile"/>
                ...
                <img src="imagenes-room/image-about-light.jpg" alt="img-mobile"/>
            </ArticleTwo>
