...
`;function F3({title:e,description:t,route:n,route_github:r,route_img:i}){const{theme:o}=_.exports.useContext(kt),[l,a]=_.exports.useState(!1);return R(L3,{color:o,children:[R(j3,{children:[d("img",{src:i,alt:"ejemplo"}),d("button",{onClick:()=>a(!0),children:d(z3,{})})]}),R(D3,{visible:l,color:o,children:[d("h3",{children:e}),d("p",{children:t}),R(I3,{children:[d("div",{children:d("a",{href:n,target:"_blank",children:d($3,{})})}),d("div",{children:d("a",{href:r,target:"_blank",children:d(A3,{})})})]}),d("button",{onClick:()=>a(!1),children:d(M3,{})})]})]})}const H3=E.section`
    min-height: 100vh;
    padding-top: 3.5rem;
    display: flex;
    flex-direction: column;
